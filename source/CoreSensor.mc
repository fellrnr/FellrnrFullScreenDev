...
//copied from https://github.com/CoreBodyTemp/ConnectIQ-CoreTemp/blob/main/CORE-DataField-Example/source/CoreSensor.mc
...
class CoreSensor extends Ant.GenericChannel {
    ...
    class CoreDataPage {
	    ...
	    function parseTemperaturePage(payload, data) {
			...
			var heatStrainIndex = payload[1] / 10.0;
			data.HeatStrainIndex = heatStrainIndex;
